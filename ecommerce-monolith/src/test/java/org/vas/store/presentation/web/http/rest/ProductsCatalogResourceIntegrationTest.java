...
public class ProductsCatalogResourceIntegrationTest {
    ...
    void testGetAll() {
        ...
        given().when().get("").then().statusCode(200)
                ...
                .body("find { it.id == 1 }.products.find { it.id == 1 }.name",
                        is("The Pragmatic Programmer"))
                .body("find { it.id == 1 }.products.find { it.id == 1 }.price", is(29.99f))
                .body("find { it.id == 1 }.products.find { it.id == 1 }.description",
                        is("Your journey to mastery"))
                // Electronics
                ...
                .body("find { it.id == 51 }.products.find { it.id == 151 }.description",
                        is("Blast past fast"))
                ...
                .body("find { it.id == 101 }.products.find { it.id == 251 }.name",
                        is("Nike Air Max 270"))
                .body("find { it.id == 101 }.products.find { it.id == 251 }.price", is(150.00f))
                .body("find { it.id == 101 }.products.find { it.id == 251 }.description", is(
                ...
                .body("find { it.id == 101 }.products.find { it.id == 201 }.name",
                        is("Levi's 501 Original Fit Jeans"))
                ...
                .body("find { it.id == 151 }.products.find { it.id == 301 }.description",
                        is("The best-selling model"))
                .body("find { it.id == 151 }.products.find { it.id == 351 }.sku", is("00000008"))
                .body("find { it.id == 151 }.products.find { it.id == 351 }.name",
                        is("Keurig K-Classic Coffee Maker"))
    ...
    void testGetByCategoryId() {
        given().when().get("/category/1").then().statusCode(200).body("size()", is(1))
                .body("find { it.id == 1 }.name", is("Books"))
                .body("find { it.id == 1 }.products.size()", is(5))
                .body("find { it.id == 1 }.products.find { it.id == 51 }.sku", is("00000002"))
                .body("find { it.id == 1 }.products.find { it.id == 51 }.name", is("Clean Code"))
