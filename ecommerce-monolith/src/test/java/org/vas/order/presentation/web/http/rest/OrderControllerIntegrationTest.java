...
public class OrderControllerIntegrationTest {
    ...
    void testSubmitCorrectOrder() {
        List<CreateOrderItemDTO> orderItems = List.of(
                new CreateOrderItemDTO("00000001", 2),
                new CreateOrderItemDTO("00000003", 1),
                new CreateOrderItemDTO("00000005", 3));
    ...
    void testSubmitOrderWithNotEnoughStockUnits() {
        List<CreateOrderItemDTO> orderItems = List.of(
                new CreateOrderItemDTO("00000001", 2),
                new CreateOrderItemDTO("00000003", 4),
                new CreateOrderItemDTO("00000005", 3));
        CreateOrderDTO order = new CreateOrderDTO(
                "John Doe", "john.doe@email.com", "123 Main St",
                BigDecimal.valueOf(4439.91), orderItems);
